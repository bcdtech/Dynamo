...
namespace Dynamo.PackageManager
{
    ...
    public class PublishPackageViewModel : NotificationObject
    {
        ...
        public bool Uploading
        {
            ...
            set
            {
                if (_uploading != value)
                {
                    ...
                    //    PublishLocallyCommand.NotifyCanExecuteChanged();
                    //});
                }
            }
        ...
        public RelayCommand PublishLocallyCommand { get; private set; }

        /// <summary>
        /// A command which, when executed, adds the selected file(s) to the PackageContents.
        /// </summary>
        public RelayCommand ShowAddFileDialogAndAddCommand { get; private set; }

        /// <summary>
        /// A command which, when executed, recursively adds the selected folders and their
        /// subfolders to the PackageContents 
        /// </summary>
        public RelayCommand SelectDirectoryAndAddFilesRecursivelyCommand { get; set; }
        ...
        public RelayCommand SelectMarkdownDirectoryCommand { get; private set; }

        /// <summary>
        /// A command, fired by the 'Reset' button in the PublishPackageView.
        /// Sets the MarkdownDirectory property to an empty string.
        /// </summary>
        public RelayCommand ClearMarkdownDirectoryCommand { get; private set; }
        ...
        /// <value>
        /// A command which, when executed, submits the current package</value>
        public RelayCommand ToggleMoreCommand { get; private set; }

        /// <summary>
        /// Sets the keywords tags based on the current KeywordList items
        /// </summary>
        public RelayCommand SetKeywordsCommand { get; private set; }
        ...
        internal PublishPackageViewModel()
        {
            ...
            PublishLocallyCommand = new RelayCommand(PublishLocally, CanPublishLocally);
            ShowAddFileDialogAndAddCommand = new RelayCommand(ShowAddFileDialogAndAdd, CanShowAddFileDialogAndAdd);
            SelectDirectoryAndAddFilesRecursivelyCommand = new RelayCommand(SelectDirectoryAndAddFilesRecursively);
            SelectMarkdownDirectoryCommand = new RelayCommand(SelectMarkdownDirectory);
            ClearMarkdownDirectoryCommand = new RelayCommand(ClearMarkdownDirectory);
            CancelCommand = new RelayCommand(Cancel);
            RemoveItemCommand = new RelayCommand<object>(RemoveItem);
            ToggleMoreCommand = new RelayCommand(() => MoreExpanded = !MoreExpanded, () => true);
            SetKeywordsCommand = new RelayCommand(SetKeywords, CanSetKeywords);
