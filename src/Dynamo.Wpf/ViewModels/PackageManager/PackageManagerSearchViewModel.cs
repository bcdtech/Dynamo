    ...
    public class PackageManagerSearchViewModel : NotificationObject
    {
        ...
        public class FilterEntry : NotificationObject
        {
            ...
            public FilterEntry(string filterName, string groupName, string tooltip, PackageManagerSearchViewModel packageManagerSearchViewModel)
            {
                ...
                GroupName = groupName;
                Tooltip = tooltip;
                FilterCommand = new RelayCommand<object>(SetFilterHosts, CanSetFilterHosts);
        ...
        /// </summary>
        public RelayCommand<object> SearchSortCommand { get; set; }

        /// <summary>
        ///     Set the sorting key for search results and resort
        /// </summary>
        public RelayCommand<object> SetSortingKeyCommand { get; set; }

        /// <summary>
        ///     Command to set the sorting direction and resort the search results
        /// </summary>
        public RelayCommand<object> SetSortingDirectionCommand { get; set; }

        /// <summary>
        /// Opens the Package Details ViewExtension
        /// </summary>
        public RelayCommand<object> ViewPackageDetailsCommand { get; set; }

        /// <summary>
        /// Clears the search text box and resets the search
        /// </summary>
        public RelayCommand<object> ClearSearchTextBoxCommand { get; set; }
        ...
        /// </summary>
        public RelayCommand<object> ClearToastNotificationCommand { get; set; }

        /// <summary>
        /// Clears all filters, setting them to `false`
        /// </summary>
        public RelayCommand<object> ClearFiltersCommand { get; set; }
        ...
        internal PackageManagerSearchViewModel()
        {
            ...
            SearchSortCommand = new RelayCommand<object>(Sort, CanSort);
            SetSortingKeyCommand = new RelayCommand<object>(SetSortingKey, CanSetSortingKey);
            SetSortingDirectionCommand = new RelayCommand<object>(SetSortingDirection, CanSetSortingDirection);
            ViewPackageDetailsCommand = new RelayCommand<object>(ViewPackageDetails);
            ClearSearchTextBoxCommand = new RelayCommand<object>(ClearSearchTextBox);
            ClearToastNotificationCommand = new RelayCommand<object>(ClearToastNotification);
            ClearFiltersCommand = new RelayCommand<object>(ClearAllFilters);
