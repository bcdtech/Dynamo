...
namespace Dynamo.ViewModels
{
    ...
    public class PackagePathViewModel : ViewModelBase
    {
        ...
        public ICommand MovePathUpCommand { get; private set; }
        public ICommand MovePathDownCommand { get; private set; }
        public ICommand UpdatePathCommand { get; private set; }
        ...
        {
            AddPathCommand = new RelayCommand(InsertPath);
            DeletePathCommand = new RelayCommand<object>(p => RemovePathAt(ConvertPathToIndex(p)), p => CanDelete(ConvertPathToIndex(p)));
            MovePathUpCommand = new RelayCommand<object>(p => SwapPath(ConvertPathToIndex(p), ConvertPathToIndex(p) - 1), p => CanMoveUp(ConvertPathToIndex(p)));
            MovePathDownCommand = new RelayCommand<object>(p => SwapPath(ConvertPathToIndex(p), ConvertPathToIndex(p) + 1), p => CanMoveDown(ConvertPathToIndex(p)));
            UpdatePathCommand = new RelayCommand<object>(p => UpdatePathAt(ConvertPathToIndex(p)), p => CanUpdate(ConvertPathToIndex(p)));
            SaveSettingCommand = new RelayCommand<object>(CommitChanges);
        }
        ...
        {
            (MovePathDownCommand as IRelayCommand)!.NotifyCanExecuteChanged();
            (MovePathUpCommand as IRelayCommand)!.NotifyCanExecuteChanged();
            (AddPathCommand as IRelayCommand)!.NotifyCanExecuteChanged();
            (DeletePathCommand as IRelayCommand)!.NotifyCanExecuteChanged();
            (UpdatePathCommand as IRelayCommand)!.NotifyCanExecuteChanged();
        }
