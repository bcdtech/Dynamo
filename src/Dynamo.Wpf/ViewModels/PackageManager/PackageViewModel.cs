...
namespace Dynamo.ViewModels
{
    public class PackageViewModel : NotificationObject
    {
        ...
        public ICommand PublishNewPackageVersionCommand { get; set; }
        public ICommand UninstallCommand { get; set; }
        public ICommand UnmarkForUninstallationCommand { get; set; }
        public ICommand LoadCommand { get; set; }
        public ICommand PublishNewPackageCommand { get; set; }
        public ICommand DeprecateCommand { get; set; }
        public ICommand UndeprecateCommand { get; set; }
        public ICommand GoToRootDirectoryCommand { get; set; }
        ...
        public PackageViewModel(DynamoViewModel dynamoViewModel, Package model)
        {
            ...
            PublishNewPackageVersionCommand = new RelayCommand(() => ExecuteWithTou(PublishNewPackageVersion), IsOwner);
            PublishNewPackageCommand = new RelayCommand(() => ExecuteWithTou(PublishNewPackage), CanSubmitNewPackage);
            UninstallCommand = new RelayCommand(Uninstall, CanUninstall);
            UnmarkForUninstallationCommand = new RelayCommand(UnmarkForUninstallation, CanUnmarkForUninstallation);
            LoadCommand = new RelayCommand(Load, CanLoad);
            DeprecateCommand = new RelayCommand(Deprecate, CanDeprecate);
            UndeprecateCommand = new RelayCommand(Undeprecate, CanUndeprecate);
            GoToRootDirectoryCommand = new RelayCommand(GoToRootDirectory, () => true);
        ...
        {
            (UninstallCommand as IRelayCommand)!.NotifyCanExecuteChanged();
        }
        ...
        {
            (UninstallCommand as IRelayCommand)!.NotifyCanExecuteChanged();
            (UnmarkForUninstallationCommand as IRelayCommand)!.NotifyCanExecuteChanged();
            (LoadCommand as IRelayCommand)!.NotifyCanExecuteChanged();
