...
namespace Dynamo.Wpf.ViewModels
{
    ...
    public class RunSettingsViewModel : ViewModelBase
    {
        ...
        public ICommand RunExpressionCommand { get; private set; }

        public ICommand CancelRunCommand { get; set; }
        ...
        public RunSettingsViewModel(RunSettings settings, HomeWorkspaceViewModel workspaceViewModel, DynamoViewModel dynamoViewModel)
        {
            ...
            CancelRunCommand = new RelayCommand<object>(CancelRun, CanCancelRun);
            RunExpressionCommand = new RelayCommand<object>(RunExpression, CanRunExpression);
        ...
        void NotifyOfGraphRunChanged()
        {
            ...
            if (string.IsNullOrEmpty(DynamoModel.HostAnalyticsInfo.HostName))
            {
                ...
                {
                    (dynamoViewModel.ShowOpenDialogAndOpenResultCommand as IRelayCommand)?.NotifyCanExecuteChanged();
                    (dynamoViewModel.NewHomeWorkspaceCommand as IRelayCommand)?.NotifyCanExecuteChanged();
                    (dynamoViewModel.OpenRecentCommand as IRelayCommand)?.NotifyCanExecuteChanged();
                    (dynamoViewModel.CloseHomeWorkspaceCommand as IRelayCommand)?.NotifyCanExecuteChanged();
                }));
            }
        }
