...
namespace Dynamo.ViewModels
{
    public class AnnotationViewModel : ViewModelBase
    {
        ...
        #region Commands
        private ICommand _changeFontSize;
        [JsonIgnore]
        public ICommand ChangeFontSize
        {
            get
            {
                if (_changeFontSize == null)
                    _changeFontSize =
                        new RelayCommand<object>(UpdateFontSize, CanChangeFontSize);
        ...
        private ICommand addGroupToGroupCommand;
        /// <summary>
        /// Adds the selected groups to this group
        /// </summary>
        [JsonIgnore]
        public ICommand AddGroupToGroupCommand
        {
            get
            {
                if (addGroupToGroupCommand == null)
                    addGroupToGroupCommand =
                        new RelayCommand<object>(AddGroupToGroup, CanAddGroupToGroup);

                return addGroupToGroupCommand;
            }
        }

        private ICommand removeGroupFromGroup;
        ...
        /// </summary>
        [JsonIgnore]
        public ICommand RemoveGroupFromGroupCommand
        {
            get
            {
                if (removeGroupFromGroup == null)
                    removeGroupFromGroup =
                        new RelayCommand<object>(RemoveGroupFromGroup, CanUngroupGroup);

                return removeGroupFromGroup;
            }
        }

        private ICommand dissolveNestedGroup;
        /// <summary>
        /// Command to dissolve hosted groups inside the host group
        /// belongs to.
        /// </summary>
        [JsonIgnore]
        public ICommand DissolveNestedGroupsCommand
        {
            get
            {
                if (dissolveNestedGroup == null)
                    dissolveNestedGroup =
                        new RelayCommand<object>(DissolveNestedGroups, CanUngroupGroup);
                ...
                using (NestedGroupsGeometries.DeferCollectionReset())
                {
                    foreach (var model in selectedModels)
                    {
                        ...
                        if (Nodes.Contains(model))
                        {
                            ...
                            (groupViewModel.AddToGroupCommand as IRelayCommand)?.NotifyCanExecuteChanged();
                            (groupViewModel.AddGroupToGroupCommand as IRelayCommand)?.NotifyCanExecuteChanged();
                            (groupViewModel.RemoveGroupFromGroupCommand as IRelayCommand)?.NotifyCanExecuteChanged();
        ...
        /// </summary>
        [JsonIgnore]
        public ICommand ToggleIsVisibleGroupCommand { get; private set; }
        #endregion
        ...
        public AnnotationViewModel(WorkspaceViewModel workspaceViewModel, AnnotationModel model)
        {
            ...
            ToggleIsVisibleGroupCommand = new RelayCommand<object>(ToggleIsVisibleGroup, CanToggleIsVisibleGroup);
        ...
        {
            (AddToGroupCommand as IRelayCommand)?.NotifyCanExecuteChanged();
            (AddGroupToGroupCommand as IRelayCommand)?.NotifyCanExecuteChanged();
            (RemoveGroupFromGroupCommand as IRelayCommand)?.NotifyCanExecuteChanged();
        }
