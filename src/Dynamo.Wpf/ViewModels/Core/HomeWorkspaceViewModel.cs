...
namespace Dynamo.Wpf.ViewModels.Core
{
    public class HomeWorkspaceViewModel : WorkspaceViewModel
    {
        ...
        [JsonIgnore]
        public ICommand StartPeriodicTimerCommand { get; set; }

        [JsonIgnore]
        public ICommand StopPeriodicTimerCommand { get; set; }

        [JsonIgnore]
        public ICommand SelectIssuesCommand { get; set; }
            ...
            : base(model, dynamoViewModel)
        {
            ...
            StartPeriodicTimerCommand = new RelayCommand<object>(StartPeriodicTimer, CanStartPeriodicTimer);
            StopPeriodicTimerCommand = new RelayCommand<object>(StopPeriodicTimer, CanStopPeriodicTimer);
            SelectIssuesCommand = new RelayCommand<object>(SelectIssues);
