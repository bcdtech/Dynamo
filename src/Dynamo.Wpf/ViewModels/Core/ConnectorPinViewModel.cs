...
namespace Dynamo.ViewModels
{
    public partial class ConnectorPinViewModel : ViewModelBase
    {
        ...
        /// </summary>
        [JsonIgnore]
        public ICommand UnpinConnectorCommand { get; set; }
        ...
        /// </summary>
        [JsonIgnore]
        public ICommand RemovePinFromGroupCommand { get; set; }
        ...
        {
            UnpinConnectorCommand = new RelayCommand<object>(UnpinWireCommandExecute);
            RemovePinFromGroupCommand = new RelayCommand<object>(RemovePinFromGroupCommandExecute, CanUngroupConnectorPin);
        }
