...
namespace Dynamo.ViewModels
{
    public class ConnectorAnchorViewModel : ViewModelBase
    {
        ...
        /// </summary>
        public ICommand PlaceWatchNodeCommand { get; set; }
        /// <summary>
        /// Delegate command to run when 'Pin Wire' item is clicked on this connector ContextMenu.
        /// </summary>
        public ICommand PinConnectorCommand { get; set; }
        ...
        {
            PlaceWatchNodeCommand = new RelayCommand<object>(PlaceWatchNodeCommandExecute);
