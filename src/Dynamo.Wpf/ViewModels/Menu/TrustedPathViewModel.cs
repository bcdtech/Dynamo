...
namespace Dynamo.ViewModels
{
    ...
    public class TrustedPathViewModel : ViewModelBase
    {
        ...
        public RelayCommand<int> DeletePathCommand { get; private set; }
        public RelayCommand<int> UpdatePathCommand { get; private set; }
        ...
        private void InitializeCommands()
        {
            ...
            DeletePathCommand = new RelayCommand<int>(p => RemovePathAt(ConvertPathToIndex(p)), p => CanDelete(ConvertPathToIndex(p)));
            UpdatePathCommand = new RelayCommand<int>(p => UpdatePathAt(ConvertPathToIndex(p)), p => CanUpdate(ConvertPathToIndex(p)));
            SaveSettingCommand = new RelayCommand(() => CommitChanges(null));
        }
        ...
        private void RaiseCanExecuteChanged()
        {
            ...
            DeletePathCommand.NotifyCanExecuteChanged();
            UpdatePathCommand.NotifyCanExecuteChanged();
        }
