...
namespace Dynamo.ViewModels
{
    ...
    public class PreferencesViewModel : ViewModelBase, INotifyPropertyChanged
    {
        ...
        public RelayCommand AddPythonPathCommand { get; private set; }
        public RelayCommand DeletePythonPathCommand { get; private set; }
        public RelayCommand UpdatePythonPathCommand { get; private set; }
        public RelayCommand<object> CopyToClipboardCommand { get; set; }


        private void InitializeCommands()
        {
            AddPythonPathCommand = new RelayCommand(AddPath);
            DeletePythonPathCommand = new RelayCommand(RemovePath, CanDelete);
            UpdatePythonPathCommand = new RelayCommand(UpdatePathAt);
