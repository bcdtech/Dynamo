...
namespace Dynamo.Services
{
    ...
    {
        public ICommand ToggleIsUsageReportingApprovedCommand { get; set; }
        public ICommand ToggleIsAnalyticsReportingApprovedCommand { get; set; }
        ...
        {
            ToggleIsAnalyticsReportingApprovedCommand = new RelayCommand<object>(
